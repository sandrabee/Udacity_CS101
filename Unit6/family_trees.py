...
def helper(genealogy, person,l):
    if person in genealogy:
        l.extend(genealogy[person])
        for i in genealogy[person]:
            helper(genealogy, i,l)
    return l

def ancestors(genealogy, person):
    l = []
    return helper(genealogy, person,l)         
...
#print ancestors(ada_family, 'Ralph King-Milbanke')
print ancestors(ada_family, 'Ada King-Milbanke')
